  ...
  constructor(database, username, password, options) {
    ...
    switch (this.getDialect()) {
      case 'mariadb':
        ...
        break;
      case 'memsql':
        Dialect = require('./dialects/memsql');
        break;
      case 'mssql':
      ...
      case 'sqlite':
        ...
        break;
      default:
        throw new Error(`The dialect ${this.getDialect()} is not supported. Supported dialects: mssql, mariadb, memsql, mysql, postgres, and sqlite.`);
    }
